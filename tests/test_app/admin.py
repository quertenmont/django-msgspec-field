...
try:
    ...
    from django_msgspec_field.forms import JSONFormSchemaWidget

    json_formfield_overrides = {MsgspecSchemaField: {"widget": JSONFormWidget}}
    json_schema_formfield_overrides = {MsgspecSchemaField: {"widget": JSONFormSchemaWidget}}
except ImportError:
